...
# from .correlation_id_vars import CORRELATION_ID  # Рекомендую вынести ContextVar в отдельный мелкий файл

CORRELATION_ID: ContextVar[str | None] = ContextVar("correlation_id", default=None)

# request middleware
async def handle_correlation_id_request(request: Request):
...
# response middleware
async def handle_correlation_id_response(request: Request, response: HTTPResponse):
